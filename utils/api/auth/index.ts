...
import {
  ...
  setTokenInStorage,
  setUserInStorage,
} from "@/utils/api/auth/tokens/tokenStorage";
...
export const login = async (
  ...
  try {
    ...
    await setTokenInStorage(ACCESS_TOKEN_KEY, accessToken);
    await setTokenInStorage(REFRESH_TOKEN_KEY, refreshToken);
...
export const refreshTokens = async () => {
  try {
    ...
    console.log("tokens gotten from refresh", response.data);
    return response.data;
  } catch (error) {
